...
Las estructuras de las formas ácida y básica de cada grupo es:
    ...
    \input{04_anfoterismo_de_aminoácidos.tex}
...
El $pH$ puede afectar a la estructura de los aminoácidos. El valor de $pKa$ juega un papel importante en esto. Algunos valores se muestran en la \autoref{fig:pka_en_base_a_ph}

\begin{figure}[t]
    \centering
    \includegraphics[width=0.65\textwidth]{./images/pka_en_base_a_ph.png}
    \caption{Tabla con valor de $pKa$ de algunos aminoácidos en relación a $pH$}
    \label{fig:pka_en_base_a_ph}
\end{figure}
...
Berzelius escribió a Mulder, 1838 y propuso la palabra "proteína" por ser la sustancia principal en la nutrición animal y en las cadenas tróficas.
Síntesis
