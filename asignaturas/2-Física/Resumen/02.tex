...
\section{Sistemas vectoriales}

\marginpar{\resumebox{definicion}{Vector}{\footnotesize
    PENDIENTE
}}
...
\resumebox{grey}{Sistema vectorial}{Se tiene un sistema vectorial cuando cuentas con un conjunto de vectores del mismo tipo.}
