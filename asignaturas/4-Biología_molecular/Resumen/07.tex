...
\subsection{Controles positivo y negativo}



\subsection{Ejemplos de operones}

% Colores para diagramas de operones
    ...
    \definecolor{rojo}{RGB}{230,25,25}
...
\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\input{images/fig:operon_LAC_sin_lactosa}}
    \rule{\linewidth}{0.2pt}
    \caption[Operón LAC sin lactosa]{Operón LAC sin lactosa}
    \label{fig:operon_LAC_sin_lactosa}
\end{figure}

\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\input{images/fig:operon_LAC_con_lactosa}}
    \rule{\linewidth}{0.2pt}
    \caption[Operón LAC con lactosa]{Operón LAC con lactosa}
    \label{fig:operon_LAC_con_lactosa}
\end{figure}

Como se aprecia en la \autoref{fig:operon_LAC_sin_lactosa}, la unión de la proteína represora al operador bloquea a la ARNpol e impide la transcripción de los genes estructurales (lacZ, lacY y lacA). El funcionamiento es diferente si hay lactosa en el medio, pues la lactosa se une a la proteína represora y permite que la ARNpol avanze por la hebra de ADN y realize la transcipción de los genes estructurales.
...
\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\input{images/fig:operon_TRP_sin_triptofano}}
    \rule{\linewidth}{0.2pt}
    \caption{Operón triptófano sin triptófano}
    \label{fig:operon_TRP_sin_triptofano}
\end{figure}


\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\input{images/fig:operon_TRP_con_triptofano}}
    \rule{\linewidth}{0.2pt}
    \caption{Operón triptófano con triptófano}
    \label{fig:operon_TRP_con_triptofano}
\end{figure}
...
\section{Mecanismos de atenuación} % \section{Mecanismos de metilación y acetilación}
...
\subsection{Acetilación}\label{sec:acetilación}
