...
\section{Exones e intrones}\label{sec:Exones_e_intrones}
...
\resumebox{blue}{Rompiendo el dogma central}{Estudios recientes han mostrado que el dogma central puede operar de formas no antes vistas, pues se han encontrado proteínas a partir de las cuales se codifica ADN.}

\section{Enzimas encargadas del corte}
...
\section{Estructura de los ribosomas procariotas}
...
\section{Síntesis de ARNr en eucariotas}
...
\section{Proteínas involucradas en la síntesis}
...
\section{Estructura de los ribosomas en eucariotas}
...
\section{ARN de transferencia (ARNt)}
...
\section{Terminación independiende de $\rho$}
...
\section{Terminación dependiende de $\rho$}
...
\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\input{images/fig:splicing_alternativo}}
