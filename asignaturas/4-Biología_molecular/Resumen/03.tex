...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/fig:estructura_de_un_nucleotido}
...
\subsection[Niveles de estructura]{Niveles de estructura del ADN}
...
\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\input{images/fig:dogma_central}}
