...
\marginpar{\begin{minipage}{\marginparwidth}
    \begin{figure}[H]
        \centering
        \resizebox{\linewidth}{!}{\input{images/fig:sybr_green}}
        \rule{\linewidth}{0.5pt}
...
\marginpar{\begin{minipage}{\marginparwidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{images/fig:sondas_taqman}
        \rule{\linewidth}{0.5pt}
...
\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\input{images/fig:ciclo_de_rt_qpcr}}
    \rule{\linewidth}{0.5pt}
