...
\node[especificacion] (colorante) at ([xshift=-2cm]desnaturalizacion.west) {0. Agregar colorante};
\draw[dashed, line width=0.5pt, -Stealth] (colorante.east) -- (desnaturalizacion.west);
\end{tikzpicture}