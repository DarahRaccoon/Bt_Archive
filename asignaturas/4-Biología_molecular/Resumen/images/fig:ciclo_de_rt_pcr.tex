...
\node[especificacion] (rt) at ([xshift=-2cm]desnaturalizacion.west) {0. Convertir ADN a ARN con RT};
\draw[dashed, line width=0.5pt, -Stealth] (rt.east) -- (desnaturalizacion.west);
\end{tikzpicture}