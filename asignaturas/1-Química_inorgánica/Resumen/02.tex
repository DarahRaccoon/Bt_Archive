...
\resumebox{definicion}{Radio atómico}{Es la mitad de la distancia entre los núcleos de 2 átomos de un mismo elemento que están unidos entre sí.}
...
\resumebox{definicion}{Energía de ionización}{Mínima energía que hay que suministrar a un átomo neutro y en su estado fundamental, perteneciente a un elemento en estado gaseoso, para arrancarle un electrón.}
...
\resumebox{definicion}{Afinidad electrónica}{Cantidad de energía que libera un átomo aislado en fase gaseosa para formar un ion con una carga eléctrica de -1}
...
\resumebox{definicion}{Electronegatividad}{Es la capacidad de un átomo o grupos funcionales para atraer electrones}
...
\begin{figure}[H]
    \centering
    \resizebox{\linewidth}{!}{\input{images/fig:orden_de_niveles_de_energia}}
    \rule{\linewidth}{0.5pt}
    \caption{Esquema de niveles de energía}
    \label{fig:orden_de_niveles_de_energia}
\end{figure}
\end{minipage}}
...
\resumebox{definicion}{Fermiones}{Son uno de los dos tipos básicos de partículas elementales, y se caracterizan por tener un spin semientero.}
...
\resumebox{definicion}{Regla de Hund}{“Al llenar orbitales de igual energía (los tres orbitales p, los cinco d, o los siete f) los electrones se distribuyen, siempre que sea posible, con sus espines paralelos, llenando los orbitales con la multiplicidad mayor. La configuración atómica es más estable (es decir, tiene menos energía) cuanto más electrones desapareados (espines paralelos) posee.”}
