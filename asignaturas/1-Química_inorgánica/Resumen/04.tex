...
\section{Mezclas químicas (homogéneas y heterogéneas)}



\section{Propiedades coligativas de la materia}



\section{Fenómenos de superficie}
...
\section{Concentración de soluciones}
...
\marginpar{{\resumebox{definicion}{Mol}{\small Una unidad importante en el conteo de átomos es el mol. Este funciona como el término ``docena'', pues describe una cantidad específica de ``algo'', que en el caso de la química son átomos y/o moléculas. Así pues, el mol indica la existencia de $6.022 \cdot 10^{23}$\footnote{Este número es llamado Número de Avogadro} de átomos o moléculas\citep{troChemistryStructureProperties2015}.}}
