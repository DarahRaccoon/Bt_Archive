...
\begin{itemize}
    ...
    \item $\rho cp T$ es la concentración de calor o energía térmica en \unit{\joule\per\m\cubed}
\end{itemize}
...
\begin{gather*}
    ...
    \\
    \mu = \qty{0.8007}{\cp} \cdot \frac{\qty{1d-3}{\kg\per\m\s}}{1cp} = \qty{8.007d-4}{\kg\per\m\s}
    \\
