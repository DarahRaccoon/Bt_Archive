...
\begin{threeparttable}{\setstretch{2}
\begin{tabular}{M{0.2\textwidth}M{0.2\textwidth}M{0.2\textwidth}M{0.2\textwidth}}\hline

    \theader{Aminoácido} &
    \theader{pK\textsubscript{a} de grupo carboxilo \ce{COOH}} &
    \theader{pK\textsubscript{a} de grupo amino \ce{NH_{3}^{+}}} &
    \theader{pK\textsubscript{a} de cadena lateral\tnote{1}} \\ \hline
