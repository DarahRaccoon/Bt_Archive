...
\resumebox{grey}{Anfoterismo}{Una sustancia anfótera es aquella que puede reaccionar ya sea como un ácido o como una base.}
...
Las estructuras de las formas ácida y básica de cada grupo es:
    ...
    \input{tables/tab:anfoterismo_de_aminoácidos}
...
\subsection{pH y pK\textsubscript{a}}

El pH puede afectar a la estructura de los aminoácidos. El valor de pK\textsubscript{a} juega un papel importante en esto. Algunos valores se muestran en la \autoref{tab:pka_aminoácidos}
