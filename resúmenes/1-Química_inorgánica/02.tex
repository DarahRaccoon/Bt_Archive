...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{./images/radio_atómico.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{./images/energía_de_ionización.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{./images/afinidad_electrónica.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{./images/electronegatividad.png}
