...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{images/curva_de_crecimiento_bacteriano}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/curva_diauxica}
...
\begin{figure}[H]   
    \centering
    \includegraphics[width=0.6\linewidth]{images/crecimiento_exponencial}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/crecimiento_bacteriano_log}
