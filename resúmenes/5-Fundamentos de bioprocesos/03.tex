...
El rendimiento refleja la cantidad de ``algo'' obtenido tras la inversión de otro ``algo''. En bioprocesos el elemento invertido es el sustrato ($s$), mientras que los elementos obtenidos son biomasa ($x$) y un producto dado ($p$), como lo  puede ser el etanol.
...
\begin{align*}
    \text{Rendimientos:} \qquad &Y_{xs} = 0.153
    \\
    \\
    &Y_{ps} = 0.85
    \\
    \\
    \text{Pesos molares:} \qquad &PM_{s} = \frac{180g}{mol}
    \\
    \\
    ...
    \\
    \\
    \text{Coeficientes:} \qquad &\frac{0.153g_{x}}{1g_{s}} \cdot \frac{1mol_{x}}{96g_{x}} \cdot \frac{180g_{s}}{1mol_{s}} \cdot = 0.287\frac{mol_{x}}{mol_{s}}
    \\
    \\
