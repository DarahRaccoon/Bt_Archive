...
\definition{Carbohidrato}{Los carbohidratos, también conocidos como hidratos de carbono o glúcidos, son biomoléculas orgánicas fundamentales compuestas por carbono, hidrógeno y oxígeno.\cite{pinillabermudezBiologiaMolecular2019}}

\cotidiana{Vinagre y bicarbonato}{Aunque una preparación casera muy extendida para la limpieza de superficies es la mezcla de vinagre y bicarbonato, en realidad es una mezcla con poca o nula utilidad, pues es una reacción ácido-base que genera unicamente $CO_{2}$ y agua.}

\desafiando{ADN de proteínas}{Si bien el dogma central, la base de la biología molecular, establece que el ADN solo se obtiene mediante la replicación de otras hebras de ADN, estudios recientes han encontrado mecanismos por los cuales una bacteria puede generar ADN a partir de proteínas.}

\ejercicio{Cálculo de balances de materia}{
    A partir de los siguientes datos:
    \begin{itemize}
        \item 1 mol $CH_{4}$
        \item 15 joules de calor
        \item 5 pascales de presión
    \end{itemize}
    Obten los siguientes datos:
    \begin{enumerate}
